...
import { FaRegCirclePlay, FaRegImage, FaRegStar } from "react-icons/fa6";
import HeaderRadiodifusorProfile from "../components/HeaderRadiodifusorProfie";
...
export default function EPGInfoDTV() {
  ...
  return (
    <>
      <HeaderRadiodifusorProfile titlePage="Tv UFMA" />
          ...
          <div className="p-14 h-full">
            <div className="flex flex-col  h-full">
              <div className="flex items-center gap-8">
                <img src={Indicacao10} alt="" className="w-24" />
                <div className="flex flex-col gap-4">
                  <h2 className="font-semibold text-5xl text-white">
                    Programa a Seguir Radiodifusor2
                  </h2>
                  <p className="text-2xl text-zinc-100">16:30 - 17:00</p>
                </div>
              </div>

              <div className="h-full">
                <div className=" grid grid-cols-[4fr_1fr] mt-10">
                  <p className="text-4xl text-zinc-300">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Exercitationem nesciunt nostrum similique corrupti, vel,
                    repellat unde porro maiores rerum quis illum! Ex, hic
                    impedit soluta rerum iusto eum cumque ipsa?. Lorem ipsum,
                    dolor sit amet consectetur adipisicing elit.
                  </p>

                  <div className="flex items-center justify-center">
                    <FaRegImage className="h-full" size={200} fill="#fff" />
                  </div>
                </div>
                <div className=" flex text-white mt-4 ">
                  ...
                  <div className="flex items-center">
                    <div className="border border-zinc-400 rounded-2xl p-1 mr-5 h-[100px] w-[100px] flex items-center justify-center">
                      <FaRegStar size={50} className="text-zinc-400 " />
                    </div>
                    <span className="text-3xl max-w-[280px] text-zinc-400 ">
      ...
      <footer className=" p-10 flex h-[800px] w-full  justify-between text-white">
        <div className="flex items-center">
          <div className="border border-white rounded-2xl p-1 mr-5 h-[100px] w-[100px] flex items-center justify-center">
